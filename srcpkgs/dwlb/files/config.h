...
// font
static char *fontstr = "FiraCode Nerd Font Mono:size=10";
// tag names
...
static pixman_color_t active_bg_color = HEX_COLOR(0x606060ff);
static pixman_color_t occupied_fg_color = HEX_COLOR(0xeeeeeeff);
static pixman_color_t occupied_bg_color = HEX_COLOR(0x1e1e1eff);
static pixman_color_t inactive_fg_color = HEX_COLOR(0xeeeeeeff);
static pixman_color_t inactive_bg_color = HEX_COLOR(0x1e1e1eff);
static pixman_color_t urgent_fg_color = HEX_COLOR(0x1e1e1eff);
static pixman_color_t urgent_bg_color = HEX_COLOR(0xeeeeeeff);
static pixman_color_t middle_bg_color = HEX_COLOR(0x1e1e1eff);
static pixman_color_t middle_bg_color_selected = HEX_COLOR(0x1e1e1eff);
